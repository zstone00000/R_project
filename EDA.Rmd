...
theme(axis.title = element_blank(), axis.text = element_blank()) +
scale_fill_continuous(type = "viridis") +
labs(title = "O3-attributable asthma visits (adult)", fill = 'Hospital visits per 100k')
```
...
theme(axis.title = element_blank(), axis.text = element_blank()) +
scale_fill_continuous(type = "viridis") +
labs(title = "O3 across NYC", fill = 'O3 concentration (ppb)')
```
...
theme(axis.title = element_blank(), axis.text = element_blank()) +
scale_fill_continuous(type = "viridis") +
labs(title = "PM2.5 concentration across NYC", fill = 'Average PM2.5 \n concentration (mcg/cm3)')
```
